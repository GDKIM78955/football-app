...
# 각 탭별 부품 파일 임포트 및 실행
from tabs import tab1_eval

with tab1:
    tab1_eval.render(history_df, GOOGLE_SHEET_WEBAPP_URL)

with tab2:
    st.info("📱 2번 탭은 곧 연결될 예정입니다.")

with tab3:
    st.info("🔍 3번 탭은 곧 연결될 예정입니다.")

with tab4:
    st.info("🎯 4번 탭은 곧 연결될 예정입니다.")

with tab5:
    st.info("👥 5번 탭은 곧 연결될 예정입니다.")

with tab6:
    st.info("🏆 6번 탭은 곧 연결될 예정입니다.")
