...
# League weights dictionary
LEAGUE_WEIGHTS = {
    # 최신 Opta 파워랭킹 기준 리그 가중치
LEAGUE_WEIGHTS = {
    # Top 5 유럽 빅리그 (91.6 ~ 85.4점 기준)
...
with col2:
    ...
    # Fair Value = Market Value * League Weight * Age Weight
    ...
    m_col2.metric(
        ...
        delta=f"{diff:+,.1f}M (€)",
        delta_color="inverse"  # Overpay will be red, bargain green
    )
